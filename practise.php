...
<body>
    ...
    <div class="container">
        ...
        if (isset($_POST['submit'])) {
            ...
            $city = htmlspecialchars($_POST['country']);
            $pass = $_POST['pwd'];
            $confipass = htmlspecialchars($_POST['confirm_pwd']);
            $terms = isset($_POST['terms_conditions']) ? $_POST['terms_conditions'] : '';
            ...
            $sql = "INSERT INTO userinformation (Name, Email, Password, Confirm_Password, Date_of_birth, Country_Name, Gender, description) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
